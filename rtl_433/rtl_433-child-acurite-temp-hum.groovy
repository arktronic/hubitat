...
metadata {
  definition(name: "rtl_433 Child Device Acurite Temperature Humidity Sensor", namespace: "arktronic", author: "Sasha Kotlyar") {
    capability "Battery"
...
def processIncomingEvent(eventName, eventDataMap)
{
  ...
  if (eventDataMap["humidity"] != null) {
    humidity = eventDataMap["humidity"]
    sendEvent(name: "humidity", value: humidity, descriptionText: "Humidity is ${humidity}%")
  }
