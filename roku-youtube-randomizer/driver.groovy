...
metadata {
    definition (name: "RokuYouTubeRandomizer", namespace: "arktronic", author: "Sasha Kotlyar", importUrl: "https://raw.githubusercontent.com/arktronic/hubitat/main/roku-youtube-randomizer/driver.groovy") {
        capability "Switch"
	}
    ...
    preferences {
        ...
        input(name: "youtubeVideoSource", type: "string", title:"YouTube Video Source", description: "Location of the JSON file with YouTube videos to choose from", defaultValue: "https://raw.githubusercontent.com/arktronic/hubitat/main/roku-youtube-randomizer/youtube-videos.json", required: true, displayDuringSetup: true)
